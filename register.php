        ...
        $(document).ready(function(){
            $("#password_confirm2").on('keyup',function(){
                ...
                if(password_confirm1 == password_confirm2){
                    $("#status_for_confirm_password").html('<strong style="color:green">Password Matches</strong>');
                }
                else{
        ...
        <table align="left" width="70%">
            <tr align="left">
                <td colspan="4">
                    <h2>Register</h2><br />
                    <span>
                        Already have an account? <a href="index.php?action=login">Login Now</a><br /><br />
                    </span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3"><input type="password" id="password_confirm2" name="confirm_password" required placeholder="Password" />
...
<?php 
    if(isset($_POST['register'])){
       if(!empty($_POST['email'])&&!empty($_POST['password'])&&!empty($_POST['confirm_password'])&&!empty($_POST['name'])){
           ...
           if($email_count > 0){
                echo "<script>alert('Sorry, this email address $email already exists in our database')</script>";
           }
