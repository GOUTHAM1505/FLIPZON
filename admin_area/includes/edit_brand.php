    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <table align="center" width="100%">
            ...
            <tr>
                ...
                <td><input type="text" name="product_brand" <?php echo $fetch_brand['brand_title']; ?> size="60" required/></td>
            </tr>
...
if(isset($_POST['edit_brand'])){
    ...
    if($edit_brand){
        echo "<script>alert('Product brand was updated succesfully!')</script>";
